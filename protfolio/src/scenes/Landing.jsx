            ...
            <div className="z-30 basis-2/5 mt-12 md:mt-32">
                {/* HEADING  */}
                    ...
                    <p className="text-6xl font-playfair z-10 text-center md:text-start">
                        Jane {""}
                        <span className="xs:relative xs:text-deep-blue xs:font-semibold z-20 xs:before:content-brush before:absolute before:-left-[25px] before:-top-[80px] before:z-[-1]">Esper</span>
                    </p>
                    <p
                     className="mt-10 mb-7 text-sm text-center md:text-start pl-5"                     
                     >
                    ...
                    onClick={()=> setSelecedPage("contact")}
                    href="#contact"
                    >
                    Contact Me
                    </AnchorLink>
